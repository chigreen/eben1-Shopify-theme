...
### Design Aesthetic
- Deep void black background (#030303)
- Otherworldly gold accent (#D4AF37)
...
:root {
  /* Colors */
  --color-primary: #D4AF37;       /* Otherworldly gold */
  --color-primary-dim: #A88B2C;   /* Muted gold for hover */
  --color-bg: #030303;            /* Deep void */
  --color-bg-elevated: #0A0A0A;
  --color-bg-card: #080808;
  --color-text: #E8E8E8;
  --color-text-muted: #6B6B6B;
  --color-text-dim: #3D3D3D;
  --color-accent: #5A7D8C;        /* Lunar blue */
  --color-border: #1A1A1A;
