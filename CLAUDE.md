...
**Logo Format**: `EBEN1 <span>Speed</span>` (Speed in silver accent)

### Design Aesthetic
- Industrial black background (#050505)
- Silver/white accent (#E8E8E8)
- Animated CSS "Starmap" background (cold white parallax)
...
```css
:root {
  /* Colors - Industrial black with silver accent */
  --color-primary: #E8E8E8;       /* Industrial silver */
  --color-primary-dim: #999999;   /* Muted silver for hover */
  --color-bg: #050505;            /* Industrial black */
  --color-bg-elevated: #111111;
  --color-bg-card: #0A0A0A;
  --color-text: #F0F0F0;
  --color-text-muted: #888888;
  --color-text-dim: #555555;
  --color-accent: #CCCCCC;        /* Light silver */
  --color-border: #222222;
  --color-glow: rgba(232, 232, 232, 0.15);
...
- **Design Branch**: `industrial-v1` (active)
...
2. **Logo HTML**: `EBEN1 <span>Speed</span>` with span in silver
3. **Comments**: Section files start with `<!-- Section Name - EBEN1 Speed -->`
4. **Button classes**: `.btn-primary` (silver), `.btn-secondary` (outline)
5. **Section labels**: Mono font, 0.625rem, uppercase, silver color
